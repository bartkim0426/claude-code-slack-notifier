...
# Notification Hook
curl -fsSL "https://raw.githubusercontent.com/[your-org]/claude-slack-notifier/main/hooks/notification-hook.sh" \
    -o "$INSTALL_DIR/hooks/notification-hook.sh"

# Stop Hook
curl -fsSL "https://raw.githubusercontent.com/[your-org]/claude-slack-notifier/main/hooks/stop-hook.sh" \
...
echo ""
echo "도움말: https://github.com/[your-org]/claude-slack-notifier"